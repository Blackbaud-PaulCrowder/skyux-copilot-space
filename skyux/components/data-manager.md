...
The initial configuration for the data manager. See the [SkyDataManagerConfig](/skyux/components/data-manager?docs-active-tab=testing#interface_sky-data-manager-config.md) interface.

#### `defaultDataState: SkyDataManagerState`

The data state used if no settings key is provided or if no data state is saved in the SKY UI config service for the user. See the [SkyDataManagerState](/skyux/components/data-manager?docs-active-tab=testing#class_sky-data-manager-state.md) interface.
...
The selected [SkyDataManagerSortOption](/skyux/components/data-manager?docs-active-tab=testing#interface_sky-data-manager-sort-option.md) to apply.
